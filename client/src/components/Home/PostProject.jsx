...
const PostProject = () => {
  ...
  return (
    <div style={{background: 'conic-gradient(from 102.04deg at 50% 50%, #C5D4FF 0deg, rgba(191, 207, 255, 0.114583) 318.75deg, rgba(192, 208, 255, 0.0677083) 335.63deg, rgba(194, 210, 255, 0) 360deg)'}} className="w-screen h-screen overflow-hidden flex flex-col items-center justify-center">
